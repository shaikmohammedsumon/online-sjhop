        ...
        <div class="main-menu">
            ...
            <div data-simplebar>
                <ul class="app-menu">
                    ...
                    <li class="menu-item">
                        <a class='menu-link waves-effect waves-light' href='{{route('pforile.update')}}'>
                    ...
                    <li class="menu-item">
                        <a href="#Manegement" data-bs-toggle="collapse" class="menu-link waves-effect waves-light">
                            ...
                            <span class="menu-text"> Role Manegement</span>
                            <span class="menu-arrow"></span>
                        </a>

                        <div class="collapse" id="Manegement">
                            <ul class="sub-menu">

                                <li class="menu-item">
                                    <a class='menu-link ' href='{{route('manager.details')}}'>
                                        <span class="menu-text">show Manager</span>
                                    </a>
                                </li>

                                <li class="menu-item">
                                    <a class='menu-link' href='{{route('seller.details')}}'>
                                        <span class="menu-text">show Seller</span>
                                    </a>
                                </li>
                            ...
                            <ul class="sub-menu">
                                <li class="menu-item">
                                    <a class='menu-link' href='{{route('products.index')}}'>
                                        <span class="menu-text">Show All Products</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a class='menu-link' href='{{route('products.create')}}'>
                                        <span class="menu-text">Post New Products</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="topbar">
                    ...
                    <ul class="topbar-menu d-flex align-items-center gap-4">
                        ...
                        <li class="dropdown d-none d-md-inline-block">
                            <a class="nav-link dropdown-toggle waves-effect waves-light arrow-none" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                                <img src="{{asset('dashboard_asset')}}/images/flags/us.jpg" alt="user-image" class="me-0 me-sm-1" height="18">
                            </a>
                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated">

                                <!-- item-->
                                <a href="javascript:void(0);" class="dropdown-item">
                                    <img src="{{asset('dashboard_asset')}}/images/flags/germany.jpg" alt="user-image" class="me-1" height="12"> <span class="align-middle">German</span>
                                </a>

                                <!-- item-->
                                <a href="javascript:void(0);" class="dropdown-item">
                                    <img src="{{asset('dashboard_asset')}}/images/flags/italy.jpg" alt="user-image" class="me-1" height="12"> <span class="align-middle">Italian</span>
                                </a>

                                <!-- item-->
                                <a href="javascript:void(0);" class="dropdown-item">
                                    <img src="{{asset('dashboard_asset')}}/images/flags/spain.jpg" alt="user-image" class="me-1" height="12"> <span class="align-middle">Spanish</span>
                                </a>

                                <!-- item-->
                                <a href="javascript:void(0);" class="dropdown-item">
                                    <img src="{{asset('dashboard_asset')}}/images/flags/russia.jpg" alt="user-image" class="me-1" height="12"> <span class="align-middle">Russian</span>
                                </a>
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <div class="notify-icon">
                                                        <img src="{{asset('dashboard_asset')}}/images/users/avatar-2.jpg" class="img-fluid rounded-circle" alt="" />
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1 text-truncate ms-2">
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item p-0 notify-item card read-noti shadow-none mb-1">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <div class="notify-icon">
                                                        <img src="{{asset('dashboard_asset')}}/images/users/avatar-4.jpg" class="img-fluid rounded-circle" alt="" />
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1 text-truncate ms-2">
                        ...
                        <li class="dropdown">
                            <a class="nav-link dropdown-toggle nav-user me-0 waves-effect waves-light" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                                ...
                                <img src="{{asset('upload/defualt/defualt.jpg')}}" alt="user-image" class="rounded-circle">
                                @else
...
<script>
    @if(session('crated_user'))
        Toastify({
        text: "{{session('crated_user')}}",
        duration: 3000,
